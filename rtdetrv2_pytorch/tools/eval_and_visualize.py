...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pred-box-width", type=int, default=8, help="Line width for predicted boxes.")
    parser.add_argument("--gt-box-width", type=int, default=6, help="Line width for GT boxes when --draw-gt is used.")
